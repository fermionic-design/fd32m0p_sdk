...
#define DMA_DEFAULT_STRIDE_SRC_INCR                     0
#define DMA_DEFAULT_STRIDE_DST_INCR                     0
...
#define DMA_DEFAULT_SRC_PROT_CTRL                       0
#define DMA_DEFAULT_DST_PROT_CTRL                       0
