...
/**
 * timer_generic_set_counter_ctrl
 */
...
/**
 * timer_generic_set_input_channel_cfg
 */
...
/**
 * timer_generic_set_output_channel_cfg
 */
...
void timer_generic_set_init_cfg(TIMER_TIMG_NUM_INPUT2_REGS_s *TIMER_REGS, timer_clk_cfg_t *clk_cfg, timer_ctr_cfg_t *ctr_cfg) {
    timer_generic_set_clk_cfg(TIMER_REGS, clk_cfg);
    //up counter in repeat mode advancing every clock
    timer_generic_set_counter_ctrl(TIMER_REGS, ctr_cfg);
    timer_generic_set_load_val(TIMER_REGS, 0xFFFF); 
    timer_generic_clk_enable(TIMER_REGS);
    timer_generic_start(TIMER_REGS);
}

/**
 * timer_generic_delay_in_us
...
void timer_generic_delay_in_us(TIMER_TIMG_NUM_INPUT2_REGS_s *TIMER_REGS, uint16_t delay_in_us) {
    ...
    timer_generic_set_clk_cfg(TIMER_REGS, timer_clk_cfg);
    timer_generic_clk_enable(TIMER_REGS);
    ...
    //timer_generic_set_clk_cfg(TIMER_REGS, timer_clk_cfg);
    //timer_generic_set_counter_ctrl(TIMER_REGS, ctr_cfg);
    //timer_generic_set_load_val(TIMER_REGS, load_val); 
    //timer_generic_clk_enable(TIMER_REGS);
    //timer_generic_start(TIMER_REGS);
    ...
    //timer_generic_clk_disable(TIMER_REGS);
...
void timer_generic_delay_in_ms(TIMER_TIMG_NUM_INPUT2_REGS_s *TIMER_REGS, uint16_t delay_in_ms) {
    ...
    timer_generic_set_counter_ctrl(TIMER_REGS, ctr_cfg);
    timer_generic_set_load_val(TIMER_REGS, load_val);
    timer_generic_set_compare_val(TIMER_REGS, comp_val, 0);
...
/**
 * timer_generic_set_pwm_output_channel_action_cfg
 */
...
/**
 * timer_generic_set_capture_channel_ctrl
...
void timer_generic_set_pwm_cfg(TIMER_TIMG_NUM_INPUT2_REGS_s *TIMER_REGS, timer_clk_cfg_t *clk_cfg, timer_pwm_cfg_t *pwm_cfg) {
    ...
    timer_generic_set_counter_ctrl(TIMER_REGS, &pwm_cfg->ctr_cfg);
    ...
    if(pwm_cfg->ctr_cfg.ctr_mode == TIMER_CTR_CTL_COUNT_MODE_UP) {
        ...
        timer_generic_set_load_val(TIMER_REGS, pwm_cfg->pwm_period>>1); 
        pwm_act_cfg->ccu_act  = TIMER_CC0_CC_PWM_CFG_CC_OUT_CCU_0_HIGH;
        pwm_act_cfg->ccd_act  = TIMER_CC0_CC_PWM_CFG_CC_OUT_CCD_0_LOW;
    }

    timer_generic_set_load_val(TIMER_REGS, load_val); 
    timer_generic_set_compare_val(TIMER_REGS, comp_val, pwm_cfg->chan_num);
    timer_generic_set_pwm_output_channel_action_cfg(TIMER_REGS, pwm_act_cfg, pwm_cfg->chan_num);
    timer_generic_set_output_channel_cfg(TIMER_REGS, &pwm_cfg->out_chan_cfg, pwm_cfg->chan_num);
    timer_generic_set_capture_channel_ctrl(TIMER_REGS, &pwm_cfg->cap_chan_ctrl, pwm_cfg->chan_num);
}
