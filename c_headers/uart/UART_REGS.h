...
typedef struct UART_REGS_s{
    ...
    volatile  UART_RST_STS_u RST_STS;
              UART_CLK_CTRL_u CLK_CTRL;
              UART_CLK_SEL_u CLK_SEL;
              UART_CLK_DIV_u CLK_DIV;
              UART_DBG_CTRL_u DBG_CTRL;
    volatile  UART_INTR_EVENT_u INTR_EVENT;
              UART_INTR_EN0_u INTR_EN0;
              UART_INTR_EN1_u INTR_EN1;
              UART_INTR_NMI_EN0_u INTR_NMI_EN0;
              UART_INTR_NMI_EN1_u INTR_NMI_EN1;
              UART_INTR_SW_SET_u INTR_SW_SET;
              UART_DMA_RX_EVENT_EN0_u DMA_RX_EVENT_EN0;
              UART_DMA_RX_EVENT_EN1_u DMA_RX_EVENT_EN1;
              UART_DMA_TX_EVENT_EN0_u DMA_TX_EVENT_EN0;
              UART_DMA_TX_EVENT_EN1_u DMA_TX_EVENT_EN1;
    volatile  UART_INTR_STS_u INTR_STS;
    volatile  UART_CLKCFG_u CLKCFG;
              UART_FIFOLS_u FIFOLS;
    volatile  UART_FIFOSTS_u FIFOSTS;
              UART_CFG_u CFG;
              UART_GFCTL_u GFCTL;
    volatile  UART_TXDATA_u TXDATA[2];
    volatile  UART_RXDATA_u RXDATA[2];
              UART_BRDNUM_u BRDNUM;
              UART_BRDDEN_u BRDDEN;
              UART_CTRL_u CTRL;
              UART_ADDR_u ADDR;
              UART_ADDRMASK_u ADDRMASK;
