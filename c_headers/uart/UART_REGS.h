 ...
 */
typedef enum {
	UART_INTR_EVENT_RCV_TIMEOUT_IDX = 0, ///<0x0
	UART_INTR_EVENT_FRAME_ERR_IDX = 1, ///<0x1
	UART_INTR_EVENT_PARITY_ERR_IDX = 2, ///<0x2
	UART_INTR_EVENT_UNDERFLOW_ERR_IDX = 3, ///<0x3
	UART_INTR_EVENT_OVERFLOW_ERR_IDX = 4, ///<0x4
	UART_INTR_EVENT_MAJ_VOTE_ERR_IDX = 5, ///<0x5
	UART_INTR_EVENT_TX_FIFO_ALMOST_FULL_IDX = 6, ///<0x6
	UART_INTR_EVENT_TX_FIFO_FULL_IDX = 7, ///<0x7
	UART_INTR_EVENT_TX_FIFO_ALMOST_EMPTY_IDX = 8, ///<0x8
	UART_INTR_EVENT_TX_FIFO_EMPTY_IDX = 9, ///<0x9
	UART_INTR_EVENT_RX_FIFO_ALMOST_FULL_IDX = 10, ///<0xa
	UART_INTR_EVENT_RX_FIFO_FULL_IDX = 11, ///<0xb
	UART_INTR_EVENT_RX_FIFO_ALMOST_EMPTY_IDX = 12, ///<0xc
	UART_INTR_EVENT_RX_FIFO_EMPTY_IDX = 13, ///<0xd
	UART_INTR_EVENT_RCV_NEGEDGE_IDX = 14, ///<0xe
	UART_INTR_EVENT_RCV_POSEDGE_IDX = 15, ///<0xf
	UART_INTR_EVENT_RX_INT_IDX = 16, ///<0x10
	UART_INTR_EVENT_TX_INT_IDX = 17, ///<0x11
	UART_INTR_EVENT_CTS_INT_IDX = 18, ///<0x12
	UART_INTR_EVENT_ADDR_MATCH_IDX = 19, ///<0x13
	UART_INTR_EVENT_BAUD_ERR_IDX = 20, ///<0x14
	UART_INTR_EVENT_EOT_IDX = 21, ///<0x15
	UART_INTR_EVENT_DMA_DONE_TX_INTR_IDX = 22, ///<0x16
	UART_INTR_EVENT_DMA_DONE_RX_INTR_IDX = 23, ///<0x17
} UART_INTR_EVENT_E;
