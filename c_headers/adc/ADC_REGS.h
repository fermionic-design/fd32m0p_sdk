...
/** @defgroup ADC_DMA_EVENT_EN_0_REG 
 *  @{
 */
typedef struct {
...
/** @} end of ADC_DMA_EVENT_EN_0_REG */ 

/** @defgroup ADC_DMA_EVENT_EN_1_REG 
 *  @{
 */
typedef struct {
...
typedef struct {
    ...
    volatile  ADC_DMA_EVENT_EN_0_u DMA_EVENT_EN_0; ///< 0x00000028
    volatile  ADC_DMA_EVENT_EN_1_u DMA_EVENT_EN_1; ///< 0x0000002C
 ...
 */
typedef enum {
	ADC_INTR_EVENT_TRIG_TO_DMA_FLAG_IDX = 0, ///<0x0
	ADC_INTR_EVENT_OV_FLAG_IDX = 1, ///<0x1
	ADC_INTR_EVENT_SEQ_OV_FLOW_IDX = 2, ///<0x2
	ADC_INTR_EVENT_WC_IN_FLAG_IDX = 3, ///<0x3
	ADC_INTR_EVENT_WC_HIGH_FLAG_IDX = 4, ///<0x4
	ADC_INTR_EVENT_WC_LOW_FLAG_IDX = 5, ///<0x5
	ADC_INTR_EVENT_DMA_DONE_IDX = 6, ///<0x6
	ADC_INTR_EVENT_UF_FLAG_IDX = 7, ///<0x7
	ADC_INTR_EVENT_RESULT0_FLAG_IDX = 8, ///<0x8
	ADC_INTR_EVENT_RESULT1_FLAG_IDX = 9, ///<0x9
	ADC_INTR_EVENT_RESULT2_FLAG_IDX = 10, ///<0xa
	ADC_INTR_EVENT_RESULT3_FLAG_IDX = 11, ///<0xb
	ADC_INTR_EVENT_RESULT4_FLAG_IDX = 12, ///<0xc
	ADC_INTR_EVENT_RESULT5_FLAG_IDX = 13, ///<0xd
	ADC_INTR_EVENT_RESULT6_FLAG_IDX = 14, ///<0xe
	ADC_INTR_EVENT_RESULT7_FLAG_IDX = 15, ///<0xf
	ADC_INTR_EVENT_RESULT8_FLAG_IDX = 16, ///<0x10
	ADC_INTR_EVENT_RESULT9_FLAG_IDX = 17, ///<0x11
	ADC_INTR_EVENT_RESULT10_FLAG_IDX = 18, ///<0x12
	ADC_INTR_EVENT_RESULT11_FLAG_IDX = 19, ///<0x13
	ADC_INTR_EVENT_RESULT12_FLAG_IDX = 20, ///<0x14
	ADC_INTR_EVENT_RESULT13_FLAG_IDX = 21, ///<0x15
	ADC_INTR_EVENT_RESULT14_FLAG_IDX = 22, ///<0x16
	ADC_INTR_EVENT_RESULT15_FLAG_IDX = 23, ///<0x17
} ADC_INTR_EVENT_E;
...
/** @} */
/** @addtogroup ADC_RESULT_REG  
 *  @{
 */
typedef enum {
	ADC_RESULT_DATA_CHNL_0 = 0, ///< 0x0
	ADC_RESULT_DATA_CHNL_1 = 1, ///< 0x1
	ADC_RESULT_DATA_CHNL_2 = 2, ///< 0x2
	ADC_RESULT_DATA_CHNL_3 = 3, ///< 0x3
	ADC_RESULT_DATA_CHNL_4 = 4, ///< 0x4
	ADC_RESULT_DATA_CHNL_5 = 5, ///< 0x5
	ADC_RESULT_DATA_CHNL_6 = 6, ///< 0x6
	ADC_RESULT_DATA_CHNL_7 = 7, ///< 0x7
	ADC_RESULT_DATA_CHNL_8 = 8, ///< 0x8
	ADC_RESULT_DATA_CHNL_9 = 9, ///< 0x9
	ADC_RESULT_DATA_CHNL_10 = 10, ///< 0xa
	ADC_RESULT_DATA_CHNL_11 = 11, ///< 0xb
	ADC_RESULT_DATA_CHNL_12 = 12, ///< 0xc
	ADC_RESULT_DATA_CHNL_13 = 13, ///< 0xd
	ADC_RESULT_DATA_CHNL_14 = 14, ///< 0xe
	ADC_RESULT_DATA_CHNL_15 = 15, ///< 0xf
} ADC_RESULT_E;
/** @} */
...
#define ADC_DMA_EVENT_EN_0_TRIG_TO_DMA_EN_OFS (0)
#define ADC_DMA_EVENT_EN_0_TRIG_TO_DMA_EN_MASK ((uint32_t)0x00000001U)
#define ADC_DMA_EVENT_EN_0_OV_DMA_EN_OFS (1)
#define ADC_DMA_EVENT_EN_0_OV_DMA_EN_MASK ((uint32_t)0x00000002U)
#define ADC_DMA_EVENT_EN_0_SEQ_OV_DMA_EN_OFS (2)
#define ADC_DMA_EVENT_EN_0_SEQ_OV_DMA_EN_MASK ((uint32_t)0x00000004U)
#define ADC_DMA_EVENT_EN_0_WC_IN_DMA_EN_OFS (3)
#define ADC_DMA_EVENT_EN_0_WC_IN_DMA_EN_MASK ((uint32_t)0x00000008U)
#define ADC_DMA_EVENT_EN_0_WC_HIGH_DMA_EN_OFS (4)
#define ADC_DMA_EVENT_EN_0_WC_HIGH_DMA_EN_MASK ((uint32_t)0x00000010U)
#define ADC_DMA_EVENT_EN_0_WC_LOW_DMA_EN_OFS (5)
#define ADC_DMA_EVENT_EN_0_WC_LOW_DMA_EN_MASK ((uint32_t)0x00000020U)
#define ADC_DMA_EVENT_EN_0_DMA_DONE_DMA_EN_OFS (6)
#define ADC_DMA_EVENT_EN_0_DMA_DONE_DMA_EN_MASK ((uint32_t)0x00000040U)
#define ADC_DMA_EVENT_EN_0_UF_DMA_EN_OFS (7)
#define ADC_DMA_EVENT_EN_0_UF_DMA_EN_MASK ((uint32_t)0x00000080U)
#define ADC_DMA_EVENT_EN_0_RESULT0_DMA_EN_OFS (8)
#define ADC_DMA_EVENT_EN_0_RESULT0_DMA_EN_MASK ((uint32_t)0x00000100U)
#define ADC_DMA_EVENT_EN_0_RESULT1_DMA_EN_OFS (9)
#define ADC_DMA_EVENT_EN_0_RESULT1_DMA_EN_MASK ((uint32_t)0x00000200U)
#define ADC_DMA_EVENT_EN_0_RESULT2_DMA_EN_OFS (10)
#define ADC_DMA_EVENT_EN_0_RESULT2_DMA_EN_MASK ((uint32_t)0x00000400U)
#define ADC_DMA_EVENT_EN_0_RESULT3_DMA_EN_OFS (11)
#define ADC_DMA_EVENT_EN_0_RESULT3_DMA_EN_MASK ((uint32_t)0x00000800U)
#define ADC_DMA_EVENT_EN_0_RESULT4_DMA_EN_OFS (12)
#define ADC_DMA_EVENT_EN_0_RESULT4_DMA_EN_MASK ((uint32_t)0x00001000U)
#define ADC_DMA_EVENT_EN_0_RESULT5_DMA_EN_OFS (13)
#define ADC_DMA_EVENT_EN_0_RESULT5_DMA_EN_MASK ((uint32_t)0x00002000U)
#define ADC_DMA_EVENT_EN_0_RESULT6_DMA_EN_OFS (14)
#define ADC_DMA_EVENT_EN_0_RESULT6_DMA_EN_MASK ((uint32_t)0x00004000U)
#define ADC_DMA_EVENT_EN_0_RESULT7_DMA_EN_OFS (15)
#define ADC_DMA_EVENT_EN_0_RESULT7_DMA_EN_MASK ((uint32_t)0x00008000U)
#define ADC_DMA_EVENT_EN_1_RESULT8_DMA_EN_OFS (0)
#define ADC_DMA_EVENT_EN_1_RESULT8_DMA_EN_MASK ((uint32_t)0x00000001U)
#define ADC_DMA_EVENT_EN_1_RESULT9_DMA_EN_OFS (1)
#define ADC_DMA_EVENT_EN_1_RESULT9_DMA_EN_MASK ((uint32_t)0x00000002U)
#define ADC_DMA_EVENT_EN_1_RESULT10_DMA_EN_OFS (2)
#define ADC_DMA_EVENT_EN_1_RESULT10_DMA_EN_MASK ((uint32_t)0x00000004U)
#define ADC_DMA_EVENT_EN_1_RESULT11_DMA_EN_OFS (3)
#define ADC_DMA_EVENT_EN_1_RESULT11_DMA_EN_MASK ((uint32_t)0x00000008U)
#define ADC_DMA_EVENT_EN_1_RESULT12_DMA_EN_OFS (4)
#define ADC_DMA_EVENT_EN_1_RESULT12_DMA_EN_MASK ((uint32_t)0x00000010U)
#define ADC_DMA_EVENT_EN_1_RESULT13_DMA_EN_OFS (5)
#define ADC_DMA_EVENT_EN_1_RESULT13_DMA_EN_MASK ((uint32_t)0x00000020U)
#define ADC_DMA_EVENT_EN_1_RESULT14_DMA_EN_OFS (6)
#define ADC_DMA_EVENT_EN_1_RESULT14_DMA_EN_MASK ((uint32_t)0x00000040U)
#define ADC_DMA_EVENT_EN_1_RESULT15_DMA_EN_OFS (7)
#define ADC_DMA_EVENT_EN_1_RESULT15_DMA_EN_MASK ((uint32_t)0x00000080U)
