...
typedef struct ADC_REGS_s{
    ...
    volatile  ADC_RST_STS_u RST_STS;
              ADC_DBG_CTRL_u DBG_CTRL;
              ADC_CLK_CTRL_u CLK_CTRL;
              ADC_CLK_SEL_u CLK_SEL;
    volatile  ADC_INTR_EVENT_u INTR_EVENT;
              ADC_INTR_EN_0_u INTR_EN_0;
              ADC_INTR_EN_1_u INTR_EN_1;
              ADC_DMA_EN_0_u DMA_EN_0;
              ADC_DMA_EN_1_u DMA_EN_1;
              ADC_EVENT_EN_0_u EVENT_EN_0;
              ADC_EVENT_EN_1_u EVENT_EN_1;
              ADC_INTR_NMI_EN_0_u INTR_NMI_EN_0;
              ADC_INTR_NMI_EN_1_u INTR_NMI_EN_1;
    volatile  ADC_INTR_STS_u INTR_STS;
              ADC_INTR_SW_u INTR_SW;
              ADC_CONV_CFG_u CONV_CFG;
              ADC_CHNL_CFG_u CHNL_CFG[16];
              ADC_RESULT_CFG_u RESULT_CFG;
              ADC_HW_AVG_CFG_u HW_AVG_CFG;
    volatile  ADC_RESULT_u RESULT[16];
              ADC_TIMER_START_u TIMER_START;
              ADC_TIMER_SAMPLE_u TIMER_SAMPLE;
              ADC_TIMER_CONVERSION_u TIMER_CONVERSION;
              ADC_WINDOW_COMP_u WINDOW_COMP;
              ADC_STATUS_u STATUS;
              ADC_DMA_REG_u DMA_REG;
              ADC_POWER_DN_u POWER_DN;
              ADC_SUBS_PORT_u SUBS_PORT;
              ADC_PUBS_PORT_u PUBS_PORT;
    volatile  ADC_CALIBRATION_REQ_u CALIBRATION_REQ;
              ADC_BLOCK_ASYNC_REQ_u BLOCK_ASYNC_REQ;
    volatile  ADC_SW_TRIGGER_u SW_TRIGGER;
              ADC_SPARE_CTRL_u SPARE_CTRL;
    volatile  ADC_SPARE_STS_u SPARE_STS;
    volatile  ADC_EOC_ANA_u EOC_ANA;
              ADC_TEMP_SENSOR_EN_u TEMP_SENSOR_EN;
    volatile  ADC_SM_STATE_u SM_STATE;
              ADC_DMA_TRANSFER_CNT_u DMA_TRANSFER_CNT;
} ADC_REGS_s;
