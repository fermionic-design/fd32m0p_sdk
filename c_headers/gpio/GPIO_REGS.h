 ...
 */
typedef enum {
	GPIO_INTR_EVENT_INTR0_IDX = 0, ///<0x0
	GPIO_INTR_EVENT_INTR1_IDX = 1, ///<0x1
	GPIO_INTR_EVENT_INTR2_IDX = 2, ///<0x2
	GPIO_INTR_EVENT_INTR3_IDX = 3, ///<0x3
	GPIO_INTR_EVENT_INTR4_IDX = 4, ///<0x4
	GPIO_INTR_EVENT_INTR5_IDX = 5, ///<0x5
	GPIO_INTR_EVENT_INTR6_IDX = 6, ///<0x6
	GPIO_INTR_EVENT_INTR7_IDX = 7, ///<0x7
	GPIO_INTR_EVENT_INTR8_IDX = 8, ///<0x8
	GPIO_INTR_EVENT_INTR9_IDX = 9, ///<0x9
	GPIO_INTR_EVENT_INTR10_IDX = 10, ///<0xa
	GPIO_INTR_EVENT_INTR11_IDX = 11, ///<0xb
	GPIO_INTR_EVENT_INTR12_IDX = 12, ///<0xc
	GPIO_INTR_EVENT_INTR13_IDX = 13, ///<0xd
	GPIO_INTR_EVENT_INTR14_IDX = 14, ///<0xe
	GPIO_INTR_EVENT_INTR15_IDX = 15, ///<0xf
	GPIO_INTR_EVENT_INTR16_IDX = 16, ///<0x10
	GPIO_INTR_EVENT_INTR17_IDX = 17, ///<0x11
	GPIO_INTR_EVENT_INTR18_IDX = 18, ///<0x12
	GPIO_INTR_EVENT_INTR19_IDX = 19, ///<0x13
	GPIO_INTR_EVENT_INTR20_IDX = 20, ///<0x14
	GPIO_INTR_EVENT_INTR21_IDX = 21, ///<0x15
	GPIO_INTR_EVENT_INTR22_IDX = 22, ///<0x16
	GPIO_INTR_EVENT_INTR23_IDX = 23, ///<0x17
	GPIO_INTR_EVENT_INTR24_IDX = 24, ///<0x18
	GPIO_INTR_EVENT_INTR25_IDX = 25, ///<0x19
	GPIO_INTR_EVENT_INTR26_IDX = 26, ///<0x1a
	GPIO_INTR_EVENT_INTR27_IDX = 27, ///<0x1b
	GPIO_INTR_EVENT_INTR28_IDX = 28, ///<0x1c
	GPIO_INTR_EVENT_INTR29_IDX = 29, ///<0x1d
	GPIO_INTR_EVENT_INTR30_IDX = 30, ///<0x1e
	GPIO_INTR_EVENT_INTR31_IDX = 31, ///<0x1f
} GPIO_INTR_EVENT_E;
