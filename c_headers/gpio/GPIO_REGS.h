...
typedef enum {
	GPIO_FILT_EN_FILT_WIDTH_0 = 0,
	GPIO_FILT_EN_FILT_WIDTH_2 = 1,
	GPIO_FILT_EN_FILT_WIDTH_4 = 2,
	GPIO_FILT_EN_FILT_WIDTH_9 = 3,
} GPIO_FILT_EN;

typedef enum {
	GPIO_INTR_POL_INTR_POL_OFF = 0,
	GPIO_INTR_POL_INTR_POS_POL = 1,
	GPIO_INTR_POL_INTR_NEG_POL = 2,
	GPIO_INTR_POL_INTR_BOTH_POL = 3,
} GPIO_INTR_POL;
