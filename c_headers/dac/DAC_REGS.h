 ...
 */
typedef enum {
	DAC_INTR_EVENT_DAC_RDY_IDX = 0, ///<0x0
	DAC_INTR_EVENT_FIFO_FULL_IDX = 1, ///<0x1
	DAC_INTR_EVENT_FIFO_ALMOST_FULL_IDX = 2, ///<0x2
	DAC_INTR_EVENT_FIFO_EMPTY_IDX = 3, ///<0x3
	DAC_INTR_EVENT_FIFO_ALMOST_EMPTY_IDX = 4, ///<0x4
	DAC_INTR_EVENT_FIFO_OVERFLOW_IDX = 5, ///<0x5
	DAC_INTR_EVENT_FIFO_UNDERFLOW_IDX = 6, ///<0x6
	DAC_INTR_EVENT_DMA_DONE_IDX = 7, ///<0x7
} DAC_INTR_EVENT_E;
