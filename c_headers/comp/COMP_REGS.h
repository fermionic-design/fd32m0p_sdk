...
typedef enum {
	COMP_CTRL0_SPEED_LOW = 0,
	COMP_CTRL0_SPEED_HIGH = 1,
} COMP_CTRL0_SPEED_E;

typedef enum {
	COMP_INPUT_CTRL0_IN_P_SEL_NON_INV_0 = 0,
	COMP_INPUT_CTRL0_IN_P_SEL_NON_INV_1 = 1,
	COMP_INPUT_CTRL0_IN_P_SEL_NON_INV_2 = 2,
	COMP_INPUT_CTRL0_IN_P_SEL_INT_DAC_OUT = 3,
	COMP_INPUT_CTRL0_IN_P_SEL_COMP0_OPA1_CONN = 4,
	COMP_INPUT_CTRL0_IN_P_SEL_COMP1_GND = 4,
	COMP_INPUT_CTRL0_IN_P_SEL_COMPX_PSEL_OUT = 5,
} COMP_INPUT_CTRL0_IN_P_SEL_E;

typedef enum {
	COMP_INPUT_CTRL0_IN_M_SEL_INV_0 = 0,
	COMP_INPUT_CTRL0_IN_M_SEL_INV_1 = 1,
	COMP_INPUT_CTRL0_IN_M_SEL_INV_2 = 2,
	COMP_INPUT_CTRL0_IN_M_SEL_COMP0_OPA0_CONN = 3,
} COMP_INPUT_CTRL0_IN_M_SEL_E;

typedef enum {
	COMP_OUT_CTRL0_OUT_POL_NON_INV = 0,
	COMP_OUT_CTRL0_OUT_POL_INV = 1,
...
typedef enum {
	COMP_OUT_CTRL1_WIN_COMP_SEL_0 = 0,
	COMP_OUT_CTRL1_WIN_COMP_SEL_1 = 1,
	COMP_OUT_CTRL1_WIN_COMP_SEL_2 = 2,
...
typedef enum {
	COMP_REF_CTRL1_DAC_CODE_SEL_0 = 0,
	COMP_REF_CTRL1_DAC_CODE_SEL_1 = 1,
