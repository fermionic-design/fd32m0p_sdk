 ...
 */
typedef enum {
	I2C_INTR_EVENT_ARB_LOST_IDX = 0, ///<0x0
	I2C_INTR_EVENT_SLV_GENCALL_INTR_IDX = 1, ///<0x1
	I2C_INTR_EVENT_SLV_START_IDX = 2, ///<0x2
	I2C_INTR_EVENT_SLV_STOP_IDX = 3, ///<0x3
	I2C_INTR_EVENT_TX_DONE_IDX = 4, ///<0x4
	I2C_INTR_EVENT_RX_DONE_IDX = 5, ///<0x5
	I2C_INTR_EVENT_SMBUS_TIMEOUT_IDX = 6, ///<0x6
	I2C_INTR_EVENT_CLKSTRETCH_TIMEOUT_IDX = 7, ///<0x7
	I2C_INTR_EVENT_PEC_ERR_IDX = 8, ///<0x8
	I2C_INTR_EVENT_TXFIFO_EMPTY_IDX = 9, ///<0x9
	I2C_INTR_EVENT_RXFIFO_FULL_IDX = 10, ///<0xa
	I2C_INTR_EVENT_TXFIFO_HALF_FULL_IDX = 11, ///<0xb
	I2C_INTR_EVENT_RXFIFO_HALF_FULL_IDX = 12, ///<0xc
	I2C_INTR_EVENT_MST_STOP_INTR_IDX = 13, ///<0xd
	I2C_INTR_EVENT_MST_START_INTR_IDX = 14, ///<0xe
	I2C_INTR_EVENT_MST_NACK_IDX = 15, ///<0xf
	I2C_INTR_EVENT_DMA_DONE_RX_IDX = 16, ///<0x10
	I2C_INTR_EVENT_DMA_DONE_TX_IDX = 17, ///<0x11
	I2C_INTR_EVENT_TXFIFO_ALMOST_EMPTY_INTR_IDX = 18, ///<0x12
	I2C_INTR_EVENT_RXFIFO_ALMOST_FULL_INTR_IDX = 19, ///<0x13
} I2C_INTR_EVENT_E;
