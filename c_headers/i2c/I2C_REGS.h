...
typedef struct I2C_REGS_s{
    ...
    volatile  I2C_RST_STS_u RST_STS;
              I2C_CLK_CTRL_u CLK_CTRL;
              I2C_DBG_CTRL_u DBG_CTRL;
              I2C_MASTER_SCL_GEN_u MASTER_SCL_GEN;
              I2C_MASTER_TIMING_CONSTRAINT_u MASTER_TIMING_CONSTRAINT;
              I2C_MASTER_CLKSTRETCH_CNT_u MASTER_CLKSTRETCH_CNT;
              I2C_SLAVE_CLKSTRETCH_CNT_u SLAVE_CLKSTRETCH_CNT;
              I2C_SMBUS_TIMEOUT_CNT_u SMBUS_TIMEOUT_CNT;
    volatile  I2C_INTR_STS_u INTR_STS;
    volatile  I2C_INTR_EVENT_u INTR_EVENT;
              I2C_INTR_EN_0_u INTR_EN_0;
              I2C_INTR_EN_1_u INTR_EN_1;
              I2C_INTR_NMI_EN_0_u INTR_NMI_EN_0;
              I2C_INTR_NMI_EN_1_u INTR_NMI_EN_1;
              I2C_RX_DMA_EVENT_EN_0_u RX_DMA_EVENT_EN_0;
              I2C_RX_DMA_EVENT_EN_1_u RX_DMA_EVENT_EN_1;
              I2C_TX_DMA_EVENT_EN_0_u TX_DMA_EVENT_EN_0;
              I2C_TX_DMA_EVENT_EN_1_u TX_DMA_EVENT_EN_1;
              I2C_INTR_SW_SET_0_u INTR_SW_SET_0;
              I2C_INTR_SW_SET_1_u INTR_SW_SET_1;
              I2C_SPARE_CTRL_u SPARE_CTRL;
    volatile  I2C_SPARE_STS_u SPARE_STS;
              I2C_GLITCH_FILTER_CFG_u GLITCH_FILTER_CFG;
              I2C_SLAVE_CTRL_u SLAVE_CTRL;
              I2C_SLAVE_ADDR_u SLAVE_ADDR;
    volatile  I2C_SLAVE_STS_u SLAVE_STS;
              I2C_SLAVE_ACK_CFG_u SLAVE_ACK_CFG;
    volatile  I2C_SLAVE_BYTE_ACK_u SLAVE_BYTE_ACK;
              I2C_FIFO_CTRL_u FIFO_CTRL;
    volatile  I2C_RXDATA_u RXDATA[2];
    volatile  I2C_TXDATA_u TXDATA[2];
    volatile  I2C_FIFO_STS_u FIFO_STS;
              I2C_PEC_CTRL_u PEC_CTRL;
    volatile  I2C_PEC_STS_u PEC_STS;
    volatile  I2C_CRC_OUT_BYTE_u CRC_OUT_BYTE;
              I2C_MASTER_CFG_u MASTER_CFG;
