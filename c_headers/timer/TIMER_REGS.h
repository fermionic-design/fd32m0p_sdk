 ...
 */
typedef enum {
	TIMER_INTR_EVENT_CTR_ZERO_IDX = 0, ///<0x0
	TIMER_INTR_EVENT_CTR_LOAD_IDX = 1, ///<0x1
	TIMER_INTR_EVENT_CCD_0_IDX = 2, ///<0x2
	TIMER_INTR_EVENT_CCU_0_IDX = 3, ///<0x3
	TIMER_INTR_EVENT_CCD_1_IDX = 4, ///<0x4
	TIMER_INTR_EVENT_CCU_1_IDX = 5, ///<0x5
	TIMER_INTR_EVENT_CCD_2_IDX = 6, ///<0x6
	TIMER_INTR_EVENT_CCU_2_IDX = 7, ///<0x7
	TIMER_INTR_EVENT_CCD_3_IDX = 8, ///<0x8
	TIMER_INTR_EVENT_CCU_3_IDX = 9, ///<0x9
	TIMER_INTR_EVENT_CCD_4_IDX = 10, ///<0xa
	TIMER_INTR_EVENT_CCU_4_IDX = 11, ///<0xb
	TIMER_INTR_EVENT_CCD_5_IDX = 12, ///<0xc
	TIMER_INTR_EVENT_CCU_5_IDX = 13, ///<0xd
	TIMER_INTR_EVENT_FAULT_IDX = 14, ///<0xe
	TIMER_INTR_EVENT_TRIG_OV_IDX = 15, ///<0xf
	TIMER_INTR_EVENT_RCTR_ZERO_IDX = 16, ///<0x10
	TIMER_INTR_EVENT_QEI_CTR_DC_IDX = 17, ///<0x11
	TIMER_INTR_EVENT_QEI_ERR_IDX = 18, ///<0x12
} TIMER_INTR_EVENT_E;
