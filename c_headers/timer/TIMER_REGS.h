...
typedef struct TIMER_REGS_s{
    ...
    volatile  TIMER_RST_STS_u RST_STS;
              TIMER_CLK_CTRL_u CLK_CTRL;
    volatile  TIMER_INTR_STS_u INTR_STS;
    volatile  TIMER_INTR_EVENT_u INTR_EVENT;
              TIMER_INTR_EN_0_u INTR_EN_0;
              TIMER_INTR_EN_1_u INTR_EN_1;
              TIMER_INTR_NMI_EN_0_u INTR_NMI_EN_0;
              TIMER_INTR_NMI_EN_1_u INTR_NMI_EN_1;
              TIMER_EVENT_EN_0_0_u EVENT_EN_0_0;
              TIMER_EVENT_EN_0_1_u EVENT_EN_0_1;
              TIMER_EVENT_EN_1_0_u EVENT_EN_1_0;
              TIMER_EVENT_EN_1_1_u EVENT_EN_1_1;
              TIMER_INTR_SW_SET_u INTR_SW_SET;
              TIMER_EVENT_CTRL_u EVENT_CTRL;
              TIMER_CLK_CONFIG_u CLK_CONFIG;
              TIMER_TRIG_IN_u TRIG_IN;
              TIMER_TRIG_OUT_u TRIG_OUT;
              TIMER_INPUT_FILTER_CC_0_u INPUT_FILTER_CC_0;
              TIMER_INPUT_FILTER_CC_1_u INPUT_FILTER_CC_1;
              TIMER_INPUT_FILTER_CC_2_u INPUT_FILTER_CC_2;
              TIMER_INPUT_FILTER_CC_3_u INPUT_FILTER_CC_3;
              TIMER_INPUT_CC_0_u INPUT_CC_0;
              TIMER_INPUT_CC_1_u INPUT_CC_1;
              TIMER_INPUT_CC_2_u INPUT_CC_2;
              TIMER_INPUT_CC_3_u INPUT_CC_3;
              TIMER_CC0_CMN_CTRL_u CC0_CMN_CTRL;
              TIMER_CC1_CMN_CTRL_u CC1_CMN_CTRL;
    volatile  TIMER_CC0_CAPTURE_CTRL_u CC0_CAPTURE_CTRL;
    volatile  TIMER_CC1_CAPTURE_CTRL_u CC1_CAPTURE_CTRL;
              TIMER_CC0_COMPARE_CTRL_u CC0_COMPARE_CTRL;
              TIMER_CC1_COMPARE_CTRL_u CC1_COMPARE_CTRL;
              TIMER_CC2_CMN_CTRL_u CC2_CMN_CTRL;
              TIMER_CC3_CMN_CTRL_u CC3_CMN_CTRL;
    volatile  TIMER_CC2_CAPTURE_CTRL_u CC2_CAPTURE_CTRL;
    volatile  TIMER_CC3_CAPTURE_CTRL_u CC3_CAPTURE_CTRL;
              TIMER_CC2_COMPARE_CTRL_u CC2_COMPARE_CTRL;
              TIMER_CC3_COMPARE_CTRL_u CC3_COMPARE_CTRL;
              TIMER_CC4_CMN_CTRL_u CC4_CMN_CTRL;
              TIMER_CC5_CMN_CTRL_u CC5_CMN_CTRL;
              TIMER_CC4_COMPARE_CTRL_u CC4_COMPARE_CTRL;
              TIMER_CC5_COMPARE_CTRL_u CC5_COMPARE_CTRL;
              TIMER_CC0_CC_PWM_CFG_u CC0_CC_PWM_CFG;
              TIMER_CC1_CC_PWM_CFG_u CC1_CC_PWM_CFG;
              TIMER_CC2_CC_PWM_CFG_u CC2_CC_PWM_CFG;
              TIMER_CC3_CC_PWM_CFG_u CC3_CC_PWM_CFG;
              TIMER_DEADBAND_CFG_u DEADBAND_CFG;
              TIMER_CC0_OUTPUT_CTL_u CC0_OUTPUT_CTL;
              TIMER_CC1_OUTPUT_CTL_u CC1_OUTPUT_CTL;
              TIMER_CC0_SW_FORCE_u CC0_SW_FORCE;
              TIMER_CC1_SW_FORCE_u CC1_SW_FORCE;
              TIMER_CC2_OUTPUT_CTL_u CC2_OUTPUT_CTL;
              TIMER_CC3_OUTPUT_CTL_u CC3_OUTPUT_CTL;
              TIMER_CC2_SW_FORCE_u CC2_SW_FORCE;
              TIMER_CC3_SW_FORCE_u CC3_SW_FORCE;
              TIMER_FAULT_IN_CTL_u FAULT_IN_CTL;
              TIMER_FAULT_SRC_CTL_u FAULT_SRC_CTL;
    volatile  TIMER_CTR_CTL_u CTR_CTL;
    volatile  TIMER_CTR_VAL_u CTR_VAL;
              TIMER_CTR_LOAD_VAL_u CTR_LOAD_VAL;
              TIMER_CTR_PL_VAL_u CTR_PL_VAL;
              TIMER_DEBUG_CTRL_u DEBUG_CTRL;
    volatile  TIMER_RCTR_VAL_u RCTR_VAL;
              TIMER_RCTR_LOAD_VAL_u RCTR_LOAD_VAL;
...
} TIMER_INPUT_CC_1_INPUT_SEL_1_E;
...
} TIMER_INPUT_CC_2_INPUT_SEL_2_E;
...
} TIMER_INPUT_CC_3_INPUT_SEL_3_E;
