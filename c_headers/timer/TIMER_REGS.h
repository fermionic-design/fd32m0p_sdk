...
typedef enum {
	TIMER_CLK_CONFIG_CLK_SEL_CLK_BUS = 0,
	TIMER_CLK_CONFIG_CLK_SEL_CLK_4MHZ = 1,
	TIMER_CLK_CONFIG_CLK_SEL_CLK_LF = 2,
} TIMER_CLK_CONFIG_CLK_SEL;
...
} TIMER_INPUT_FILTER_CC_0_FILTER_PERIOD_0;
...
} TIMER_INPUT_FILTER_CC_1_FILTER_PERIOD_1;
...
} TIMER_INPUT_FILTER_CC_2_FILTER_PERIOD_2;
...
} TIMER_INPUT_FILTER_CC_3_FILTER_PERIOD_3;

typedef enum {
	TIMER_INPUT_CC_0_INPUT_SEL_0_CCPIN_0 = 0,
	TIMER_INPUT_CC_0_INPUT_SEL_0_CCPIN_1 = 1,
...
} TIMER_INPUT_CC_0_INPUT_SEL_0;

typedef enum {
	TIMER_INPUT_CC_1_INPUT_SEL_1_CCPIN_1 = 0,
	TIMER_INPUT_CC_1_INPUT_SEL_1_CCPIN_0 = 1,
	TIMER_INPUT_CC_1_INPUT_SEL_1_CCPIN_0 = 2,
	TIMER_INPUT_CC_1_INPUT_SEL_1_TRIGGER_IN = 3,
	TIMER_INPUT_CC_1_INPUT_SEL_1_XOR_OF_HALL_INPUTS = 4,
	TIMER_INPUT_CC_1_INPUT_SEL_1_SUB_0 = 5,
	TIMER_INPUT_CC_1_INPUT_SEL_1_SUB_1 = 6,
	TIMER_INPUT_CC_1_INPUT_SEL_1_COMPARATOR_0 = 7,
	TIMER_INPUT_CC_1_INPUT_SEL_1_COMPARATOR_1 = 8,
	TIMER_INPUT_CC_1_INPUT_SEL_1_COMPARATOR_2 = 9,
} TIMER_INPUT_CC_1_INPUT_SEL_1;

typedef enum {
	TIMER_INPUT_CC_2_INPUT_SEL_2_CCPIN_2 = 0,
	TIMER_INPUT_CC_2_INPUT_SEL_2_CCPIN_3 = 1,
	TIMER_INPUT_CC_2_INPUT_SEL_2_CCPIN_0 = 2,
	TIMER_INPUT_CC_2_INPUT_SEL_2_TRIGGER_IN = 3,
	TIMER_INPUT_CC_2_INPUT_SEL_2_XOR_OF_HALL_INPUTS = 4,
	TIMER_INPUT_CC_2_INPUT_SEL_2_SUB_0 = 5,
	TIMER_INPUT_CC_2_INPUT_SEL_2_SUB_1 = 6,
	TIMER_INPUT_CC_2_INPUT_SEL_2_COMPARATOR_0 = 7,
	TIMER_INPUT_CC_2_INPUT_SEL_2_COMPARATOR_1 = 8,
	TIMER_INPUT_CC_2_INPUT_SEL_2_COMPARATOR_2 = 9,
} TIMER_INPUT_CC_2_INPUT_SEL_2;

typedef enum {
	TIMER_INPUT_CC_3_INPUT_SEL_3_CCPIN_3 = 0,
	TIMER_INPUT_CC_3_INPUT_SEL_3_CCPIN_2 = 1,
	TIMER_INPUT_CC_3_INPUT_SEL_3_CCPIN_0 = 2,
	TIMER_INPUT_CC_3_INPUT_SEL_3_TRIGGER_IN = 3,
	TIMER_INPUT_CC_3_INPUT_SEL_3_XOR_OF_HALL_INPUTS = 4,
	TIMER_INPUT_CC_3_INPUT_SEL_3_SUB_0 = 5,
	TIMER_INPUT_CC_3_INPUT_SEL_3_SUB_1 = 6,
	TIMER_INPUT_CC_3_INPUT_SEL_3_COMPARATOR_0 = 7,
	TIMER_INPUT_CC_3_INPUT_SEL_3_COMPARATOR_1 = 8,
	TIMER_INPUT_CC_3_INPUT_SEL_3_COMPARATOR_2 = 9,
} TIMER_INPUT_CC_3_INPUT_SEL_3;

typedef enum {
	TIMER_CC0_CMN_CTRL_IS_CAPTURE_0_COMPARE_MODE = 0,
	TIMER_CC0_CMN_CTRL_IS_CAPTURE_0_CAPTURE_MODE = 1,
} TIMER_CC0_CMN_CTRL_IS_CAPTURE_0;
...
} TIMER_CC0_CAPTURE_CTRL_CAP_COND_0;
...
} TIMER_CC0_CAPTURE_CTRL_LOAD_COND_0;
...
} TIMER_CC0_CAPTURE_CTRL_ZERO_COND_0;

typedef enum {
	TIMER_CC0_CAPTURE_CTRL_ADV_COND_0_DISABLE = 0,
...
} TIMER_CC0_CAPTURE_CTRL_ADV_COND_0;
...
} TIMER_CC1_CAPTURE_CTRL_CAP_COND_1;
...
} TIMER_CC1_CAPTURE_CTRL_LOAD_COND_1;
...
} TIMER_CC1_CAPTURE_CTRL_ZERO_COND_1;
...
} TIMER_CC1_CAPTURE_CTRL_ADV_COND_1;
...
} TIMER_CC0_COMPARE_CTRL_COMP_VAL_UPDATE_METHOD_0;
...
} TIMER_CC0_COMPARE_CTRL_CCACT_UPDATE_METHOD_0;
...
} TIMER_CC1_COMPARE_CTRL_COMP_VAL_UPDATE_METHOD_1;
...
} TIMER_CC2_CAPTURE_CTRL_CAP_COND_2;
...
} TIMER_CC2_CAPTURE_CTRL_LOAD_COND_2;
...
} TIMER_CC2_CAPTURE_CTRL_ZERO_COND_2;
...
} TIMER_CC2_CAPTURE_CTRL_ADV_COND_2;
...
} TIMER_CC3_CAPTURE_CTRL_CAP_COND_3;
...
} TIMER_CC3_CAPTURE_CTRL_LOAD_COND_3;
...
} TIMER_CC3_CAPTURE_CTRL_ZERO_COND_3;
...
} TIMER_CC3_CAPTURE_CTRL_ADV_COND_3;
...
} TIMER_CC2_COMPARE_CTRL_COMP_VAL_UPDATE_METHOD_2;
...
} TIMER_CC2_COMPARE_CTRL_CCACT_UPDATE_METHOD_2;
...
} TIMER_CC3_COMPARE_CTRL_COMP_VAL_UPDATE_METHOD_3;
...
} TIMER_CC3_COMPARE_CTRL_CCACT_UPDATE_METHOD_3;
...
} TIMER_CC4_COMPARE_CTRL_COMP_VAL_UPDATE_METHOD_4;
...
} TIMER_CC5_COMPARE_CTRL_COMP_VAL_UPDATE_METHOD_5;
...
} TIMER_CC0_CC_PWM_CFG_CC_OUT_CC2D_0;
...
} TIMER_CC0_CC_PWM_CFG_CC_OUT_CC2U_0;
...
} TIMER_CC0_CC_PWM_CFG_CC_OUT_CCD_0;
...
} TIMER_CC0_CC_PWM_CFG_CC_OUT_CCU_0;
...
} TIMER_CC0_CC_PWM_CFG_CC_OUT_LOAD_0;
...
} TIMER_CC0_CC_PWM_CFG_CC_OUT_ZERO_0;
...
} TIMER_CC0_CC_PWM_CFG_CC_OUT_FAULT_ENTRY_0;
...
} TIMER_CC0_CC_PWM_CFG_CC_OUT_FAULT_EXIT_0;
...
} TIMER_CC1_CC_PWM_CFG_CC_OUT_CC2D_1;
...
} TIMER_CC1_CC_PWM_CFG_CC_OUT_CC2U_1;
...
} TIMER_CC1_CC_PWM_CFG_CC_OUT_CCD_1;
...
} TIMER_CC1_CC_PWM_CFG_CC_OUT_CCU_1;
...
} TIMER_CC1_CC_PWM_CFG_CC_OUT_LOAD_1;
...
} TIMER_CC1_CC_PWM_CFG_CC_OUT_ZERO_1;
...
} TIMER_CC1_CC_PWM_CFG_CC_OUT_FAULT_ENTRY_1;
...
} TIMER_CC1_CC_PWM_CFG_CC_OUT_FAULT_EXIT_1;
...
} TIMER_CC2_CC_PWM_CFG_CC_OUT_CC2D_2;
...
} TIMER_CC2_CC_PWM_CFG_CC_OUT_CC2U_2;
...
} TIMER_CC2_CC_PWM_CFG_CC_OUT_CCD_2;
...
} TIMER_CC2_CC_PWM_CFG_CC_OUT_CCU_2;
...
} TIMER_CC2_CC_PWM_CFG_CC_OUT_LOAD_2;
...
} TIMER_CC2_CC_PWM_CFG_CC_OUT_ZERO_2;
...
} TIMER_CC2_CC_PWM_CFG_CC_OUT_FAULT_ENTRY_2;
...
} TIMER_CC2_CC_PWM_CFG_CC_OUT_FAULT_EXIT_2;
...
} TIMER_CC3_CC_PWM_CFG_CC_OUT_CC2D_3;
...
} TIMER_CC3_CC_PWM_CFG_CC_OUT_CC2U_3;
...
} TIMER_CC3_CC_PWM_CFG_CC_OUT_CCD_3;
...
} TIMER_CC3_CC_PWM_CFG_CC_OUT_CCU_3;
...
} TIMER_CC3_CC_PWM_CFG_CC_OUT_LOAD_3;
...
} TIMER_CC3_CC_PWM_CFG_CC_OUT_ZERO_3;
...
} TIMER_CC3_CC_PWM_CFG_CC_OUT_FAULT_ENTRY_3;
...
} TIMER_CC3_CC_PWM_CFG_CC_OUT_FAULT_EXIT_3;
...
} TIMER_CC0_OUTPUT_CTL_CC_OUT_SEL_0;
...
} TIMER_CC1_OUTPUT_CTL_CC_OUT_SEL_1;
...
} TIMER_CC0_SW_FORCE_CC_OUT_SW_FORCE_0;
...
} TIMER_CC0_SW_FORCE_CC_CMPL_OUT_SW_FORCE_0;
...
} TIMER_CC1_SW_FORCE_CC_OUT_SW_FORCE_1;
...
} TIMER_CC1_SW_FORCE_CC_CMPL_OUT_SW_FORCE_1;
...
} TIMER_CC2_OUTPUT_CTL_CC_OUT_SEL_2;
...
} TIMER_CC3_OUTPUT_CTL_CC_OUT_SEL_3;
...
} TIMER_CC2_SW_FORCE_CC_OUT_SW_FORCE_2;
...
} TIMER_CC2_SW_FORCE_CC_CMPL_OUT_SW_FORCE_2;
...
} TIMER_CC3_SW_FORCE_CC_OUT_SW_FORCE_3;
...
} TIMER_CC3_SW_FORCE_CC_CMPL_OUT_SW_FORCE_3;
...
} TIMER_FAULT_IN_CTL_FAULT_FILTER_PERIOD;
...
} TIMER_FAULT_SRC_CTL_FAULT_LATCH_SEL;
