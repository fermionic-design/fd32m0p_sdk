...
// @version  $State:$
// @date     $Date: 2023/07/10 11:44:18 GMT $
//
//*****************************************************************************/
 ...
 *
 *
 * This user manual describes the ARM Cortex M Series CMSDK Library which utilises the
...
/**
 *
 * @brief  Initialises the UART specifying the UART Baud rate divider value and whether the send and receive functionality is enabled. It also specifies which of the various interrupts are enabled.
 *
 ...
 * @return none
 *
 * @brief  disables the alternative function for pins. Set the bit corresponding to the pin number to 1 to disable alternate function i.e. Set bit 1 of ALtFunc to 1 to set pin 1 to the original output function. This function is thread safe.
 */
