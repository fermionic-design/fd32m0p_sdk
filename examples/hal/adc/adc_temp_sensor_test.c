//////////////////////////////////////////////////////////////////////////////
////               ADC TEMP SENSOR TEST                                   ////
////    DESCRIPTION:                                                      ////      
////        This is an example test to test ADC temp sensor.              ////
////                                                                      ////
////    Board Setup:                                                      ////
////        ADC CH11                                                      ////
////        Internal Vref , 1p4V                                          ////
...
int main(void){
    ...
    UartPuts("ADC Temperatur Sensor Test\n");
    ...
    adc_temp_cfg(ADC0_REGS, MCU_CTRL_REGS, VREF_REGS, single_ch_cfg, chnl_cfg);
    ...
    print_int_var("Temp ADC out : ", adc_out, 0);
